        ...
        >
          ...
          <div style={{padding:"18px 24px 0"}}>
            <div style={{
              ...
              alignItems:"center",
              background:"rgba(255,255,255,0.04)",
              border: `1px solid ${query ? "rgba(84,120,201,0.55)" : "rgba(255,255,255,0.10)"}`,
              borderRadius:12,
              padding:"0 14px",
                ...
                {matches.map((m, i) => (
                  <button
                    ...
                    style={{
                      ...
                      width:"100%",
                      padding:"12px 14px",
                      background: highlight === i ? "rgba(84,120,201,0.12)" : "transparent",
                      border:"1px solid",
                      borderColor: highlight === i ? "rgba(84,120,201,0.30)" : "transparent",
                      borderRadius:10,
                      cursor:"pointer",
                      textAlign:"left",
