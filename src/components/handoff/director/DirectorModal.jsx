/* DirectorModal.jsx — AI 디렉터 풀스크린 모달 (14개 카드 순차 재생) */
...
const CARD_MAP = {
  ...
  "05": Card05, "06": Card06, "07": Card07, "08": Card08,
  "09": Card09, "10": Card10, "11": Card11, "12": Card12,
  "13": Card13, "14": Card14,
};

export const DIRECTOR_SCRIPT = [
...
export default function DirectorModal({ open, onClose }) {
  ...
  const Comp = CARD_MAP[cur.card];
  const cardInfo = CARDS?.find(c => c.n === cur.card);
  const groupInfo = GROUPS?.find(g => g.cards.includes(cur.card));
        ...
        <aside className="dm-side">
          ...
          <div className="dm-side__body">
            ...
            <div className="dm-subtitle">
              <TypingText text={cur.text} speedMs={30} on={pb.playing}/>
            </div>
          </div>
