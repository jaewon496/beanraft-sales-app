...
const TOUR_SCRIPT = [
  ...
  // [2026-06-29 예언 제거] '매출 회수/회수 가능성' 회수 프레이밍 제거 → 실제 내용(매출 추이)에 맞춘 라벨.
  { card: "06", beat: "매출 분석", dur: 7200,
    text: "매출 분석입니다. 월매출 평균 9,121만 원 — 강남구 평균 7,840만 대비 +16.3%. 13개월 추이 보면 매월 +1~2% 꾸준히 오르고 있어요. 살아있는 시장입니다.",
    triggers: [
  ...
  { card: "13", beat: "투자 대비 수익률", dur: 7200,
    text: "이제 종합입니다. 투자 대비 수익률로 보면 수익성·생존은 받쳐주는데 투자 회수 축에서 점수를 깎아 먹어요. 비싼 자리라 비용 부담이 크다는 뜻 — 콘셉트로 객단가를 끌어올리면 만회됩니다.",
    triggers: [
