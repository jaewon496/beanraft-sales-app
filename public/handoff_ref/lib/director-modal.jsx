...
const DIRECTOR_SCRIPT = [
  ...
  { card:"13", beat:"5축 분해", dur:9000,
    ...
    beats:[
      { at:1200, id:"c13.axes",  anim:["drift-l","bounce"],      fx:"zoom",      phrase:"5축 분해" },
      { at:3400, id:"c13.kpi1",  anim:["rise","roulette"],       fx:"underline", phrase:"시장·생존은 강한데" },
      { at:5400, id:"c13.kpi2",  anim:["focus","glitch","flash"], fx:"box",      phrase:"비용 부담" },
      { at:7000, id:"c13.gauge", anim:["dolly","glitch"],        fx:"circle",    phrase:"종합 53점" },
    ]},
  { card:"14", beat:"최종 의견", dur:9600,
    ...
    beats:[
      { at:1500, id:"c14.radar", anim:["focus"],                          fx:"spotlight", phrase:"5축 레이더" },
      { at:4400, id:"c14.score", anim:["dolly","roulette"],               fx:"arrow",     phrase:"입지·매출·생존은 외곽" },
      { at:6800, id:"c14.kpi2",  anim:["rise","flash"],                   fx:"box",       phrase:"비용은 안쪽" },
    ]},
];
